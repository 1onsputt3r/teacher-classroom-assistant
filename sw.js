...
const CACHE_NAME = `${CACHE_PREFIX}pwa-main-20260909-draw-timer-1`;
const APP_SHELL = [
  './',
  './index.html',
  ...
  './preview-v2/styles.css?v=20260909-draw-timer-1',
  './preview-v2/app.js?v=20260909-draw-timer-1',
  './preview-v2/core.mjs?v=20260909-draw-timer-1',
  './preview-v2/timer.mjs?v=20260909-draw-timer-1'
];
